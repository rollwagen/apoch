...
require (
	...
	github.com/projectdiscovery/naabu/v2 v2.1.9
...
require (
	...
	github.com/projectdiscovery/ipranger v0.0.17 // indirect
	...
	github.com/projectdiscovery/retryablehttp-go v1.0.32 // indirect
